<div>
    ...
    <img class="max-h-48 w-full object-cover object-center" src="{{ $product->image ? asset('storage/' . $product->image) : asset('storage/photo/placeholder.jpg') }}" alt="Product Image" />
        <div class="p-4">
